...
if __name__ == "__main__":
    ...
    cluster_to_dist = { 0: 'Anecdotes, Examples and Illustration: 44%, Background Information: 12%, Expert: 9%, Main Actor: 9%, Data Resource: 7%, Counterpoint: 6%, Analysis: 4%, Confirmation and Witness: 3%, Broadening Perspective: 1%, Subject: 0%',
    ...
    cluster_file = '/pool001/spangher/alex/conditional-information-retrieval/interleaving/v3_clusters/data_cluster_assignment.csv'
    ...
    for i in range(args.iterations):
        ...
        for url in article_order:
            ...
            prompt = f"""
                ...
                Now, we need to determine the next source we should investigate, following these steps:
                ...
                We believe that, based on the initial query, this article will have some combination of the following distributions of source-types:
                {cluster_pred}

                Given these distributions and the source types we currently have, identify a source type from the list above that we should investigate next.
        ...
        fname = os.path.join(here, f"interleave_cluster_pred_iter_{i}_{args.start_idx}_{args.end_idx}.json")
