...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_data_file', type=str, default=f'{here}/../data/quick-discourse-prompts-to-run.csv.gz')
    parser.add_argument('--start_idx', type=int, default=None)
    parser.add_argument('--end_idx', type=int, default=None)
    parser.add_argument('--id_col', type=str, default='url')
    parser.add_argument('--prompt_col', type=str, default='prompt')
    parser.add_argument('--output_file', type=str, default=f'{here}/../data/v3_source_summaries/discourse-labeled/discourse_labeled.txt')
