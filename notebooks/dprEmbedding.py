...
mapfile = "/project/jonmay_231/spangher/Projects/conditional-information-retrieval/fine_tuning/mapping.json"
...
for article in tqdm(articles, desc="creating source txt folder"):
    for source in article['sources']:
        ...
        doc_vector = reloaded_retriever.embed_documents(source_text)
