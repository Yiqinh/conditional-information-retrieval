...
if __name__ == "__main__":
    ...
    #load the model
    model = load_model("/project/jonmay_231/spangher/huggingface_cache/models--meta-llama--Meta-Llama-3-70B-Instruct")
    ...
    for article in articles:
        ...
        prompt = f"""
                ...
                Only rely on the annotations I have provided, don't identify additional sources. Generate only ONE summary per source. Be sure to summarize the SAME source when it occurs multiple times across the article.
            """
